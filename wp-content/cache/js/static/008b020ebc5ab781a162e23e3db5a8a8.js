/* Tuesday 28th of January 2014 04:13:47 PM*/
...
(function($){ $(document).ready(function() {$(".nextend-hastip").qtip({
            ...
            ndojo.addOnLoad(function(){
                SmartSliderAdminSlide('nextend-smart-slider-0','0','layoutslide', 'admin.php?page=nextend-smart-slider2&controller=layouts&action=create');
            });
