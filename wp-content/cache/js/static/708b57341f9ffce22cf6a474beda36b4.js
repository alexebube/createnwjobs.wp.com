/* Tuesday 28th of January 2014 04:17:58 PM*/
...
(function(dojo){ dojo.addOnLoad(function(){
            ...
            new NextendFontmanager({
              node: "nextend-fontmanager-lightbox-e765a1fbd0e7688e5d0517e6f208d8c4"
            });
            ...
            new NextendFontmatrix({
              ...
              name: "sliderfont",
              html: ["<label id=\"settings**name**-lbl\" for=\"settings**name**\"><div class='nextend-text '><input id='settings**name**customlabel' name='settings[**name**customlabel]' value='**label**' type='text' style=''  autocomplete='off' \/><\/div><\/label>","<a id=\"nextend-**name**-button\" class=\"nextend-font-button\" href=\"#\">Font<\/a><a id=\"nextend-**name**-button-export\" class=\"nextend-button-css nextend-font-export nextend-element-hastip\" title=\"Export\" href=\"#\"><\/a><a id=\"nextend-**name**-button-import\" class=\"nextend-button-css nextend-font-import nextend-element-hastip\" title=\"Import\" href=\"#\"><\/a><div id=\"nextend-**name**-message\" class=\"nextend-message\"><\/div><div class='nextend-fontmanager clearfix'><input id='settings**name**' name='settings[**name**]' value='**value**' type='hidden' autocomplete='off' \/><\/div>"],
